...
RUN mkdir -p /home/appuser/.local/state/celery
# Default command (can be overridden by docker-compose)
CMD ["bash", "-lc", "celery -A app.license_manager.tasks.celery_app.celery_app beat -l info --schedule /home/appuser/.local/state/celery/beat-schedule"]
