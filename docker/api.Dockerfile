...
# Install project (build backend: hatchling)
...
CMD ["gunicorn", "-k", "uvicorn.workers.UvicornWorker", "app.license_manager.api.main:create_app()", "--bind", "0.0.0.0:8000", "--workers", "4", "--threads", "2"]
